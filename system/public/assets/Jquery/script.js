...
$(document).ready(function(){
	$("#transaction-question").click(function(){
	  $("#content_question").load(URL="data_external/cara_transaksi.txt", function(responseTxt, statusTxt, xhr){
		if(statusTxt == "error")
...
//kecurangan question
$(document).ready(function(){
	$("#kecurangan-question").click(function(){
	  $("#content_question").load(URL="data_external/melaporkan_kecurangan.txt", function(responseTxt, statusTxt, xhr){
		if(statusTxt == "error")
		  alert("Error: " + xhr.status + ": " + xhr.statusText);
	  });
	});
...
$(document).ready(function(){
	$("#Promo-question").click(function(){
	  $("#content_question").load(URL="data_external/penggunaan_promo.txt", function(responseTxt, statusTxt, xhr){
		if(statusTxt == "error")
		  alert("Error: " + xhr.status + ": " + xhr.statusText);
	  });
	});
...
//kecurangan question
$(document).ready(function(){
	$("#tunai-question").click(function(){
	  $("#content_question").load(URL="data_external/cara_bayar_tunai.txt", function(responseTxt, statusTxt, xhr){
		if(statusTxt == "error")
		  alert("Error: " + xhr.status + ": " + xhr.statusText);
	  });
	});
